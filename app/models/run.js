CATS.Model.Run = Classify(CATS.Model.Event, {
    init: function () {
        ...
        /*:
         ...
         "accepted", "partial", "compile_error", "runtime_error", "wrong_answer",
         "presentation_error", "memory_limit", "timie_limit", "idleness_limit",
    ...
    minutes_since_start: function () {
        if (this.minutes_since_start_cache === undefined)
            this.minutes_since_start_cache =
                (this.start_processing_time - CATS.App.contests[this.contest]
                .start_time) / (1000 * 60);
